...
"""
    ABOUT_TEXT = """
**📛 My Name** : [ＷＩＬＤ Ξ ΞＲ](http://t.me/urluploderV3_bot)

**❤️ Version** : [3.3 🔥](http://t.me/urluploderV3_bot)

**🤖 Source** : [Click](https://t.me/R_OHLI)

**🧿 Language** : [Python 3.10.9](https://www.python.org/)

**📢 Framework** : [Pyrogram 1.4.16](https://docs.pyrogram.org/)

**👨‍💻 Developer** : [𝗥𝗔𝗩𝗜 𝗞𝗢𝗛𝗟𝗜](https://t.me/R_KOHLI)
